        ...
        <Grid item xs={12} md={7}>
          ...
          <Box component="form" autoComplete="off" onSubmit={handleSubmit}>
            <Stack spacing={2}>
              ...
              <TextField name="opening" label="Opening Hours in HH:MM" variant="outlined" required onChange={handleInputChange} />
              <TextField name="closing" label="Closing Hours in HH:MM" variant="outlined" required onChange={handleInputChange} />
